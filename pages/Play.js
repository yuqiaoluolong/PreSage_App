...
export default function VideoPlayPage({ navigation }) {
    ...
    stompClient.configure({
        ...
        onConnect: () => {
            ...
            stompClient.subscribe('/camera/3/live-stream', (message) => {
                byteString = String.fromCharCode.apply(String, message._binaryBody);
                ...
                <View style={{ height: 520 }}>
                    <ScrollView>
                        <View style={{height:240, width: 350, margin: 20, backgroundColor: "gray"}}>
                            <Image ref={imageRef} style={{height: 240, width: 350}} source={require('./images/fake_live_stream.png')}/>
                        </View>
                    </ScrollView>
                </View>
